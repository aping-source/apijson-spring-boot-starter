...
public class NewIdStrategyAutoConfigurationTest {
    ...
    public void testNewIdSnowflakeStrategy() {
        applicationContextRunner
                .withPropertyValues(ApijsonConsts.PROPERTY_PREFIX_APIJSON_NEWIDSTRATEGY + "=" + ApijsonProperties.NewIdStrategy.snowflake)
    ...
    public void testNewIdTimestampStrategy() {
        applicationContextRunner
                .withPropertyValues(ApijsonConsts.PROPERTY_PREFIX_APIJSON_NEWIDSTRATEGY + "=" + ApijsonProperties.NewIdStrategy.timestamp)
                .run(context -> {
                    assertThat(context).hasSingleBean(NewIdStrategy.class);
                    NewIdStrategy strategy = context.getBean(NewIdStrategy.class);
    ...
    public void testNewIdUuidStrategy() {
        applicationContextRunner
                .withPropertyValues(ApijsonConsts.PROPERTY_PREFIX_APIJSON_NEWIDSTRATEGY + "=" + ApijsonProperties.NewIdStrategy.uuid)
                .run(context -> {
                    assertThat(context).hasSingleBean(NewIdStrategy.class);
                    NewIdStrategy strategy = context.getBean(NewIdStrategy.class);
    ...
    public void testNewIdCustomStrategy() {
        applicationContextRunner
                .withPropertyValues(ApijsonConsts.PROPERTY_PREFIX_APIJSON_NEWIDSTRATEGY + "=" + ApijsonProperties.NewIdStrategy.custom)
                .run(context -> {
                    assertThat(context).hasSingleBean(NewIdStrategy.class);
                    NewIdStrategy strategy = context.getBean(NewIdStrategy.class);
                    assertTrue(strategy instanceof NewIdCustomStrategy);
                });
    }
